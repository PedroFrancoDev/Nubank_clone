...
Color secondarYellow = const Color.fromARGB(255, 248, 214, 120);
Color greyColor = const Color.fromRGBO(240, 241, 245, 1);
Color grey50 = const Color.fromARGB(255, 195, 195, 195);
Color grey = const Color.fromARGB(255, 63, 63, 63);
Color whiteColor = const Color.fromARGB(255, 255, 255, 255);
Color yellow20 = const Color.fromARGB(255, 250, 245, 233);
